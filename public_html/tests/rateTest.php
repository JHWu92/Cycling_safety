...
class loginTest extends DBFixtureTestCase{
    ...
    # T19
        ...
        $data = array(
            ...
            [array($GLOBALS['POST_SCORE']=>3, 'btn-rate'=>1), array($GLOBALS['SESS_USER_ID']=>1, $GLOBALS['SESS_VIDEO_ID']=>3)],
            [array($GLOBALS['POST_SCORE']=>1, 'btn-rate'=>1), array($GLOBALS['SESS_USER_ID']=>2, $GLOBALS['SESS_VIDEO_ID']=>4)],
            [array($GLOBALS['POST_SCORE']=>2, 'btn-rate'=>1), array($GLOBALS['SESS_USER_ID']=>2, $GLOBALS['SESS_VIDEO_ID']=>3)],
            [array($GLOBALS['POST_SCORE']=>3, 'btn-rate'=>1), array($GLOBALS['SESS_USER_ID']=>2, $GLOBALS['SESS_VIDEO_ID']=>2)],
